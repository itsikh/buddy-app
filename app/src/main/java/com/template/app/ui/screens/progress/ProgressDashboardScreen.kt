package com.template.app.ui.screens.progress
...
import com.template.app.gamification.BadgeDefinitions
        ...
        Row(
            ...
            Column {
                val modeEmoji = when (session.mode) {
                    com.template.app.data.models.ChatMode.FREE_CHAT  -> "💬"
                    com.template.app.data.models.ChatMode.STORY_TIME -> "📖"
                    com.template.app.data.models.ChatMode.ROLE_PLAY  -> "🎭"
                }
